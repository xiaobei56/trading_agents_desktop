...
> 合规提示：本项目是开源技术研究/演示工具，分析内容可能综合第三方财经数据、联网搜索结果、AI 搜索和模型生成输出，仅供学习研究与技术支持，不构成任何投资建议、证券推荐或收益承诺。
...
- 分析结果可能综合第三方财经数据、公开网页、联网搜索、AI 搜索和大模型生成内容，存在延迟、缺失、误差、幻觉或过时风险。
- 本项目仅提供技术支持与辅助分析能力，不提供投资建议、证券推荐、收益承诺、代客理财或其他持牌金融服务。
- 使用者应自行核验关键数据，并独立承担投资、交易、税务、法律和业务风险。
- 第三方数据源、模型服务和网络链路的准确性、可用性和合规性，由各自服务提供方负责。
- 桌面端会在本机保存部分 API Key 与配置，请自行做好设备和密钥安全管理。
- 如需商业化、面向客户分发，或嵌入受监管业务场景，建议先咨询律师和合规顾问。

完整版本见：[合规声明与免责声明](docs/legal/LEGAL_DISCLAIMER_ZH.md)
...
- [合规声明与免责声明](docs/legal/LEGAL_DISCLAIMER_ZH.md)
...
- 本项目仅用于研究、学习和辅助分析
- 程序输出可能来自第三方财经数据、联网搜索、AI 搜索和模型生成内容
- 不构成任何投资建议、证券推荐或收益承诺
- 分析结果依赖模型质量、数据源状态、网络环境和提示词行为
- 详细风险提示和免责边界见 [docs/legal/LEGAL_DISCLAIMER_ZH.md](docs/legal/LEGAL_DISCLAIMER_ZH.md)
